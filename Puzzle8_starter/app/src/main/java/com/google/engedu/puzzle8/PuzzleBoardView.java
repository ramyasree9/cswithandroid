...
public class PuzzleBoardView extends View {
    ...
    public PuzzleBoardView(Context context) {
        ...
        animation = null;
     //   initialize(context.imageBitmap,null);
    }
    ...
    public void shuffle() {
        if (animation == null && puzzleBoard != null) {
            ...
            int rand=newboards.size();
            rand=random.nextInt(rand);
            puzzleBoard=newboards.get(rand);
            // Do something.
        }
    }
    ...
    public void solve() {
        PriorityQueue<PuzzleBoard> pq = new PriorityQueue<>(100, new Comparator<PuzzleBoard>() {
            @Override
